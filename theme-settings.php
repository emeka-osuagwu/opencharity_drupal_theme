 ...
 */
function opencharity_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['opencharity_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('opencharity sample setting'),
  '#default_value' => theme_get_setting('opencharity_example'),
